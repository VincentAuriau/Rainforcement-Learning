...
#        print('WTF')
#        print(observation, action, reward, stop)
        self.agent.reward(observation, action, reward, stop)
    ...
    def loop(self, games, max_iter):
        ...
        for g in range(1, games+1):
            ...
            if True or self.verbose:
                ...
                a = [self.agent.xs, self.agent.vs, self.agent.acts, self.agent.episode_rewards]
...
#                plt.title('POSITION')
#                plt.subplot(4, 1, 2)
#                plt.plot(list(range(len(a[1]))), a[1])
#                plt.title('SPEED')
#                plt.subplot(4, 1, 3)
